...
const OriginalIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-12 h-12">
    <path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17 17.25 21A2.652 2.652 0 0 0 21 17.25l-5.83-5.83m0 0a2.652 2.652 0 1 1-3.75-3.75 2.652 2.652 0 0 1 3.75 3.75Zm-9.58-9.44a2.652 2.652 0 0 0-3.75 3.75l5.83 5.83m0 0a2.652 2.652 0 0 1 3.75-3.75 2.652 2.652 0 0 1-3.75 3.75Z" />
  </svg>
)
...
const ContactIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-12 h-12">
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.883.213 1.5 1.015 1.5 1.912v6.705a2.25 2.25 0 0 1-2.25 2.25H4.5a2.25 2.25 0 0 1-2.25-2.25V10.423c0-.897.617-1.699 1.5-1.912l1.447-.348a18.333 18.333 0 0 1 14.506 0l1.447.348Z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M18.914 13.409a2.25 2.25 0 1 1-3.596 2.632M15.75 9l-4.5 4.5m0 0-4.5-4.5m4.5 4.5V3" />
  </svg>
)
...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc]">
      ...
      <section className="relative w-full h-[105vh] min-h-[600px] bg-zinc-950">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <span className="mt-auto font-bold text-blue-600 flex items-center gap-2 text-xs uppercase tracking-[0.2em] group-hover:underline underline-offset-4">
              เข้าสู่ระบบเลือกยี่ห้อ <span className="group-hover:translate-x-1 transition-transform">→</span>
            </span>
          </Link>
          ...
          >
            ...
            <span className="mt-auto font-bold text-red-600 flex items-center gap-2 text-xs uppercase tracking-[0.2em] group-hover:underline underline-offset-4">
              เลือกชมสินค้าแต่ง <span className="group-hover:translate-x-1 transition-transform">→</span>
            </span>
          </Link>
          ...
          <div className="group bg-zinc-900 p-10 rounded-2xl shadow-2xl shadow-black/20 border border-zinc-800 flex flex-col items-center text-center relative overflow-hidden">
            ...
            <div className="text-zinc-400 text-sm space-y-3 mb-8 relative z-10">
              <p className="flex items-center justify-center gap-2">
                <span className="w-16 text-right text-xs uppercase tracking-widest text-zinc-500">Line</span>
                <span className="text-white font-bold text-lg">@shodaiev</span>
              </p>
              <p className="flex items-center justify-center gap-2">
                <span className="w-16 text-right text-xs uppercase tracking-widest text-zinc-500">Call</span>
